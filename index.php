...
<html class="no-js" lang="en">
  <head>
    ...
    <!-- Site Title -->
    <title>Plus IT Business Park</title>
  ...
  <body>
    ...
    <!-- <div class="cs-hero cs-style1 cs-bg cs-fixed_bg cs-shape_wrap_1" data-src="assets/img/bg2.jpeg" id="home" 
      ...
      <div class="container">
        <!-- <div class="cs-hero_text">
          ...
          <div class="cs-hero_info">
            ...
            <div>
              <div class="cs-hero_subtitle"> </div>
            </div>
          </div>
        </div>
      </div> -->
        ...
        <div class="cs-funfact_wrap cs-type1">
          ...
          <div class="cs-funfact_right">
            <div class="cs-funfacts">
              ...
              <div class="cs-funfact cs-style1">
                <div class="cs-funfact_number cs-primary_font cs-semi_bold cs-primary_color">
                  <span data-count-to="21" class="odometer"></span>
                </div>
                <div class="cs-funfact_text">
                  <span class="cs-accent_color">+</span>
              ...
              <div class="cs-funfact cs-style1">
                <div class="cs-funfact_number cs-primary_font cs-semi_bold cs-primary_color">
                  <span data-count-to="63" class="odometer"></span>
                </div>
                <div class="cs-funfact_text">
                  <span class="cs-accent_color">+</span>
          ...
          <div class="col-xl-4">
            <div class="cs-section_heading cs-style1">
              ...
              <a href="service.html" class="cs-text_btn wow fadeInLeft" data-wow-duration="0.8s" data-wow-delay="0.2s">
                ...
                <svg width="26" height="12" viewBox="0 0 26 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M25.5303 6.53033C25.8232 6.23744 25.8232 5.76256 25.5303 5.46967L20.7574 0.696699C20.4645 0.403806 19.9896 0.403806 19.6967 0.696699C19.4038 0.989593 19.4038 1.46447 19.6967 1.75736L23.9393 6L19.6967 10.2426C19.4038 10.5355 19.4038 11.0104 19.6967 11.3033C19.9896 11.5962 20.4645 11.5962 20.7574 11.3033L25.5303 6.53033ZM0 6.75H25V5.25H0V6.75Z" fill="#ff3399"></path>
                </svg>
              </a>
            </div>
          ...
          <div class="cs-slider_wrapper">
            <div class="cs-slide">
              <a href="portfolio-details.html" class="cs-portfolio cs-style1 cs-bg">
                <div class="cs-portfolio_hover"></div>
                <div class="cs-portfolio_bg" data-src="assets/img/flo2.jpeg"></div>
                <!-- <div class="cs-portfolio_info">
                  <div class="cs-portfolio_info_bg cs-accent_bg"></div>
            ...
            <div class="cs-slide">
              <a href="portfolio-details.html" class="cs-portfolio cs-style1 cs-bg">
                <div class="cs-portfolio_hover"></div>
                <div class="cs-portfolio_bg" data-src="assets/img/avard1.jpeg"></div>
                <!-- <div class="cs-portfolio_info">
                  <div class="cs-portfolio_info_bg cs-accent_bg"></div>
                  <h2 class="cs-portfolio_title">Colorful Art Work</h2>
                  <div class="cs-portfolio_subtitle">See Details</div>
            ...
            <div class="cs-slide">
              <a href="portfolio-details.html" class="cs-portfolio cs-style1 cs-bg">
                <div class="cs-portfolio_hover"></div>
                <div class="cs-portfolio_bg" data-src="assets/img/astra1.jpeg"></div>
                <!-- <div class="cs-portfolio_info">
                  <div class="cs-portfolio_info_bg cs-accent_bg"></div>
                  <h2 class="cs-portfolio_title">Colorful Art Work</h2>
                  <div class="cs-portfolio_subtitle">See Details</div>
            ...
            <div class="cs-slide">
              <a href="portfolio-details.html" class="cs-portfolio cs-style1 cs-bg">
                <div class="cs-portfolio_hover"></div>
                <div class="cs-portfolio_bg" data-src="assets/img/artees.jpg"></div>
                <!-- <div class="cs-portfolio_info">
                  <div class="cs-portfolio_info_bg cs-accent_bg"></div>
                  <h2 class="cs-portfolio_title">Colorful Art Work</h2>
                  <div class="cs-portfolio_subtitle">See Details</div>
      ...
      <!-- <div class="container" >
        <div class="cs-slider cs-style1 cs-gap-24">
          <div class="cs-slider_left">
            <div class="cs-section_heading cs-style1">
              <h3 class="cs-section_subtitle wow fadeInLeft" data-wow-duration="0.8s" data-wow-delay="0.2s"> Our Reviews </h3>
              <h2 class="cs-section_title">We get multiple Reviews</h2>
            </div>
            <div class="cs-height_45 cs-height_lg_20"></div>
        ...
        <div class="new-feature-slider">
          <div id="slider-1" class="feature-slide active">
            <div class="block-wrap w50 new-feature-image-wrap mob-auto">
              <div class="block">
                <div class="feature-slide-image">
                  <div class="" style="background-image:url('assets/img/t3.jpg');">
            ...
            <div class="block-wrap w50 center-content mob-auto">
              <div class="block" style="background-color: #181818">
                <div class="content-centered overview-text">
                  <h2 class="fakeh1">Jovin C Varghese</h2>
           ...
           <div id="slider-2" class="feature-slide">
            <div class="block-wrap w50 new-feature-image-wrap mob-auto">
              <div class="block">
                <div class="feature-slide-image">
                  <div class="" style="background-image:url('assets/img/t2.jpg');">
            ...
            <div class="block-wrap w50 center-content mob-auto">
              <div class="block">
                <div class="content-centered overview-text">
                  <h2 class="fakeh1">Shabeer Khalid</h2>
                  <span class="divider-wave blue-wave"></span>
                  <p>Chairman</p>
          ...
          <div id="slider-3" class="feature-slide">
            <div class="block-wrap w50 new-feature-image-wrap mob-auto">
              <div class="block">
                <div class="feature-slide-image">
                  <div class="" style="background-image:url('assets/img/t4.jpg');">
            ...
            <div class="block-wrap w50 center-content mob-auto">
              <div class="block">
                <div class="content-centered overview-text">
                  <h2 class="fakeh1">Rosliya Varghese</h2>
                  <span class="divider-wave blue-wave"></span>
                  <p>CXO</p>
            ...
            <div class="slider-nav cs-style1">
                ...
                <div class="slider-nav_item">
                  <div class="cs-rotate_img">
                    <div class="cs-rotate_img_in">
                      <img src="assets/img/edu.png" alt="Nav Image" >
                    </div>
                  </div>
                </div>
              </div>
              <div class="slider-for_item item-nav">
                <div class="slider-nav_item">
                  <div class="cs-rotate_img">
                    <div class="cs-rotate_img_in">
                      <img src="assets/img/hyden.png" alt="Nav Image">
                    </div>
                  </div>
                </div>
              </div>
              <div class="slider-for_item item-nav">
                <div class="slider-nav_item">
                  <div class="cs-rotate_img">
                    <div class="cs-rotate_img_in">
                      <img src="assets/img/testimonial-3.png" alt="Nav Image">
                    </div>
                  </div>
                </div>
              </div>
              <div class="slider-for_item item-nav">
                <div class="slider-nav_item">
                  <div class="cs-rotate_img">
                    <div class="cs-rotate_img_in">
                      <img src="assets/img/rvk.png" alt="Nav Image">
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="slider-for_item item-nav">
                <div class="slider-nav_item">
                  <div class="cs-rotate_img">
                    <div class="cs-rotate_img_in">
                      <img src="assets/img/avard.png" alt="Nav Image">
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="slider-for cs-style1">
              <div class="slider-for_item">
                <div class="cs-testimonial cs-style1">
                  ...
                  <div class="cs-testimonial_text">Plus IT Park's exceptional digital marketing and sales force support, along with the outstanding website delivered, truly propelled our sales to new heights.</div>
                  ...
                  <h2 class="cs-testimonial_avatar_name">Edu Pace Academy</h2>
                  <div class="cs-testimonial_avatar_designation text-uppercase">Language Training Institute Kerala</div>
                </div>
              </div>
              <div class="slider-for_item">
                <div class="cs-testimonial cs-style1">
                  ...
                  <div class="cs-testimonial_text">Kudos to the Plus IT Park team for doing an amazing job with our social media. They've truly exceeded our expectations.</div>
                  <div class="cs-rating" data-rating="4">
                    <div class="cs-rating_bg" data-src="assets/img/rating.svg"></div>
                    <div class="cs-rating_percentage" data-src="assets/img/rating.svg"></div>
                  </div>
                  <h2 class="cs-testimonial_avatar_name">Hayden</h2>
                  <div class="cs-testimonial_avatar_designation text-uppercase"> Language Training Institute KERALA</div>
                </div>
              </div>
              <div class="slider-for_item">
                <div class="cs-testimonial cs-style1">
                  ...
                  <div class="cs-testimonial_text">From website development to direct marketing support, our experience working with Plus IT Park has been excellent. Doing business with them has been truly rewarding.</div>
                  <div class="cs-rating" data-rating="4">
                    <div class="cs-rating_bg" data-src="assets/img/rating.svg"></div>
                    <div class="cs-rating_percentage" data-src="assets/img/rating.svg"></div>
                  </div>
                  <h2 class="cs-testimonial_avatar_name">Florence Academy</h2>
                  <div class="cs-testimonial_avatar_designation text-uppercase">Education & Careers Kerala & Tamilnadu</div>
                </div>
              </div>
              <div class="slider-for_item">
                <div class="cs-testimonial cs-style1">
                  ...
                  <div class="cs-testimonial_text">Plus IT Park's strategic development efforts have had a significant and delightful impact on our business. We look forward to continuing our journey with them. </div>
                  <div class="cs-rating" data-rating="4">
                    <div class="cs-rating_bg" data-src="assets/img/rating.svg"></div>
                    <div class="cs-rating_percentage" data-src="assets/img/rating.svg"></div>
                  </div>
                  <h2 class="cs-testimonial_avatar_name">RVK Properties</h2>
                  <div class="cs-testimonial_avatar_designation text-uppercase">Construction and Building Kerala</div>
                </div>
              </div>
              <div class="slider-for_item">
                <div class="cs-testimonial cs-style1">
                  ...
                  <div class="cs-testimonial_text">Plus IT Park's work on our website and app expanded our reach, and their dedication impressed us. Blessings for their outstanding work!</div>
                  <div class="cs-rating" data-rating="4">
                    <div class="cs-rating_bg" data-src="assets/img/rating.svg"></div>
                    <div class="cs-rating_percentage" data-src="assets/img/rating.svg"></div>
                  </div>
                  <h2 class="cs-testimonial_avatar_name">AVARD | Apex Voluntary Agency For Rural Development</h2>
                  <div class="cs-testimonial_avatar_designation text-uppercase">NGO Chalakudi - Thrissur, Kerala</div>
                </div>
              </div>
              <!-- <div class="slider-for_item">
                <div class="cs-testimonial cs-style1">
    ...
    background-repeat: no-repeat; background-position: bottom 70px right 100px; ">
      ...
      <div class="container">
        <div class="cs-slider cs-style1 cs-gap-24">
          <div class="cs-slider_left">
            <div class="cs-section_heading cs-style1">
              <h3 class="cs-section_subtitle">Our Clients</h3>
              <h2 class="cs-section_title">Explore Our Clients</h2>
              <div class="cs-height_45 cs-height_lg_20"></div>
              ...
              <div class="cs-slider_container" data-autoplay="1" data-loop="1" data-speed="1000" data-center="0" data-variable-width="1" data-slides-per-view="responsive" data-xs-slides="1" data-sm-slides="2" data-md-slides="2" data-lg-slides="2" data-add-slides="3">
                <div class="cs-slider_wrapper">
                  ...
                  <div class="cs-slide">
                    <div class="cs-post cs-style1">
                      <a href="blog-details.html" class="cs-post_thumb">
                        <img src="assets/img/clients-2.jpg" alt="Post">
                        <div class="cs-post_overlay"></div>
                      </a>
                      <div class="cs-post_info">
                        <!-- <div class="cs-posted_by">10 Feb 2022</div> -->
                        <h2 class="cs-post_title">
                          <a href="blog-details.html">AVARD | Apex Voluntary Agency For Rural Development</a>
                        </h2>
                      </div>
                    </div>
                  </div>
