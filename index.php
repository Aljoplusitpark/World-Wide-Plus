...
<html class="no-js" lang="en">
  ...
  <body>
    ...
    <?php include("includes/header.php") ?>
      ...
      <div class="cs-hero " style="position:relative;" id="sound_volume">
        <video autoplay muted loop id="myVideo" style="width: 1550px; height: auto;">
          <source src="assets/img/videos/slider-1.mp4" type="video/mp4" /> 
        </video>
        <i class="fa-solid fa-volume-off sound" style="bottom:170px ; right: 50px; font-size: 30px; color: #ff3399; position: absolute; "></i>
      </div>
