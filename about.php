        ...
        <div class="row">
          <div class="col-xl-5 col-lg-7">
            <div class="cs-section_heading cs-style1">
              ...
              <p class="cs-m0">We offer a wide array of services, including web development, DAPP development, custom-made software solutions, 
          ...
          <div class="col-lg-7">
            <img src="assets/img/s2.jpg" alt="Thumb" class="w-100 cs-radius_15">
  ...
  <div class="container">
    <div class="cs-slider cs-style2 cs-gap-24">
      <div class="cs-slider_heading cs-style1">
        <div class="cs-section_heading cs-style1">
          <!-- <h3 class="cs-section_subtitle">Our Team</h3> -->
          <h2 class="cs-section_title">Web Design</h2>
        </div>
        ...
        <div class="cs-slider_wrapper">
          <div class="cs-slide">
            <div class="cs-team cs-style1">
              <div class="cs-member_thumb1">
                <img src="assets/img/flo.jpeg" alt="Member" >
          ...
          <div class="cs-slide">
            <div class="cs-team cs-style1">
              <div class="cs-member_thumb1">
                <img src="assets/img/avard1.jpeg" alt="Member">
                <div class="cs-member_overlay"></div>
              </div>
              <!-- <div class="cs-member_info">
          ...
          <div class="cs-slide">
            <div class="cs-team cs-style1">
              <div class="cs-member_thumb1">
                <img src="assets/img/artees.jpg" alt="Member">
                <div class="cs-member_overlay"></div>
              </div>
              <!-- <div class="cs-member_info">
          ...
          <div class="cs-slide">
            <div class="cs-team cs-style1">
              <div class="cs-member_thumb1">
                <img src="assets/img/astra1.jpeg" alt="Member">
                <div class="cs-member_overlay"></div>
              </div>
              <!-- <div class="cs-member_info">
          ...
          <div class="cs-slide">
            <div class="cs-team cs-style1">
              <div class="cs-member_thumb1">
                <img src="assets/img/avard.jpeg" alt="Member">
                <div class="cs-member_overlay"></div>
              </div>
              <!-- <div class="cs-member_info">
                <h2 class="cs-member_name">Melon Bulgery</h2>
